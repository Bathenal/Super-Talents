document.addEventListener("DOMContentLoaded", function () {
    ...
    employerLoginBtn.addEventListener("click", function (event) {
      ...
      const epassword = employerLoginForm.querySelector('input[name="epassword"]').value;
    ...
    freelancerLoginBtn.addEventListener("click", function (event) {
      ...
      // Get the input values
      const fname = freelancerLoginForm.querySelector('input[name="fname"]').value;
      const fpassword = freelancerLoginForm.querySelector('input[name="fpassword"]').value;
    ...
    function validateEmployerLogin(ename, epassword) {
      ...
      const storedEpassword = localStorage.getItem("employerPassword");
